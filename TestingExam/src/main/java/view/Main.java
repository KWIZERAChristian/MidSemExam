...
public class Main {
    public static void main(String[] args) {
        ...
        while (condition) {
            System.out.println(" Auca Student Registration System.");
            System.out.println("**********************************");
            ...
            System.out.println("8. list of course per student and semester.");
            ...
            switch (choice) {
                ...
                case 3:
                    System.out.println("Register student in the system");
                    System.out.println("*******************************");
